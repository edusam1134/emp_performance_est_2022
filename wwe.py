...
# a=data['Net Connectivity']data['Performance Rating']
...
data['Feedbacks '] = data['Feedbacks '].fillna(data['Feedbacks '].mean())
...
x_train, x_test, y_train, y_test = train_test_split(data[['JobInvolvement','position','department','RelationshipSatisfaction',
      'Working from home or office ','OverTime','WorkLifeBalance', 'Project evlaution /Completeion', 'Feedbacks ', 'Experience',
      'Ticket Solving Managements ','On time Delivery','environment satisifaction','Psycho-Social Indicators',
      'TrainingTime(months)','Workign hrs ','Attendance','Effected with corona','Job Level','JobSatisfaction','Behaviourial Competence']],data['Performance Rating'])
